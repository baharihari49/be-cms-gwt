...
const prismaClient_1 = __importDefault(require("../prismaClient")); // Sesuaikan dengan export Anda
// Validation schemas
...
class AuthController {
    ...
    static async changePassword(req, res) {
        try {
            ...
            const isPasswordValid = await bcrypt_1.default.compare(validatedData.currentPassword, user.password);
            if (!isPasswordValid) {
